...
exists to give the frontend a stable HTTP interface. Persistence, authentication, file
ingestion, AI analysis, and LMS adapters can be added behind that interface as the next
vertical slices.
